class CoursesController < ApplicationController
  ...
  private
    ...
    def course_params
      params.require(:course).permit(:name, :description, sections_attributes: [ :id, :title, :objective, :_destroy, lessons_attributes: [ :id, :title, :notes, :_destroy, video_attributes: [ :id, :video_url ], lesson_uploads_attributes: [ :id, :_destroy ], uploads_files: [ ] ] ])
    end
